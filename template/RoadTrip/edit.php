<div class="relative">
    <img src="<?= $data['roadTrip']->getIllustration() != null ? $data['roadTrip']->getIllustration() : "https://picsum.photos/1920/1080/?random" ?>" class="w-full brightness-50 lg:h-full h-[50vh] lg:object-fill object-none"
