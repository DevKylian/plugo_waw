<div class="relative">
    <img src="<?= $data['roadTrip']->getIllustration() != null ? $data['roadTrip']->getIllustration() : "https://picsum.photos/600/400/?random" ?>" class="w-full brightness-50 lg:h-full h-[50vh] lg:object-fill object-none"
                ...
                <div class="flex justify-center">
                    <div class="block p-6 rounded-lg shadow-lg bg-white w-full">
                        ...
                        <p class="text-gray-700 text-base mb-4">
                            ...
                            <input type="hidden" id="coordonnes-depart" placeholder="Coordonnees" name="checkPoint[checkPoint<?=  $currentCheckPointVal->getId() ?>][coordonnees]" value="<?php  echo htmlspecialchars($currentCheckPointVal->getCoordonnee()) ?>" class="input shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white" required>
                            <label class="block text-gray-700 text-sm font-bold mb-2">
