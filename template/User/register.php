<div class="flex flex-col my-20 items-center">
        ...
        <a href="index.php?page=connexion" class="text-center text-blue-500 hover:text-blue-600 underline my-10">Vous avez déjà un compte ? <br> Cliquez ici pour vous connecter !</a>
    </div>
